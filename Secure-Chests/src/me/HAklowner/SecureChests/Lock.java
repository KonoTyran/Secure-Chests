...
public class Lock {
    ...
    //end new API calls
    public boolean onAccessList(CraftClan clan) {
    ...
    public boolean onDenyList(CraftClan clan) {
    ...
    public boolean onGlobalList(CraftClan clan) {
    ...
    public boolean addToAccessList(CraftClan clan) {
        String clanTag = clan.getTag().toLowerCase();
        if (!clanAccess.containsKey(clanTag)) {
    ...
    public boolean addToDenyList(CraftClan clan) {
    ...
    public Integer getAccess(String player) {
        ...
        if (plugin.usingSimpleClans) {
            //ClanPlayer cp = plugin.simpleClans.getClanManager().getClanPlayerManager(player);
            ClanPlayer cp = (ClanPlayer) plugin.simpleClans.getClanPlayerManager();
